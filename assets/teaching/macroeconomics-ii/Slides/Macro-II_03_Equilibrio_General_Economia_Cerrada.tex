...
\begin{frame}{Aumento la productividad total de los factores}
  Considere
  \[
    z_2>z_1.
  \]
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.42\textwidth}
      ...
      \begin{itemize}
        ...
        \item El efecto sobre \(\ell\) y \(N\) es ambiguo: depende de las preferencias del consumidor representativo.
      \end{itemize}
    \end{column}
...
\begin{frame}{El modelo de esta sesión}
  Comenzamos con decisiones individuales:
  \[
    \text{preferencias} - \text{tecnología} - \text{política}.
  \]

  El equilibrio las traduce en variables agregadas:
  \[
    (C^*,Y^*,N^*,w^*).
  \]
